...
<head>
  ...
  <title>OLLS | Clients Log in</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <!-- Font Awesome -->
  <link rel="stylesheet" href="{% static 'plugins/fontawesome-free/css/all.min.css' %}" content-type="text/css">
  <!-- Ionicons -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="http://localhost:8000"><b>OLLS </b>Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
     <!--Messages----------------------------> 
