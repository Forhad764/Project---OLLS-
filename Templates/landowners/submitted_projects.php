...
<head>
  ...
  <title>Landowner | Projects </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Landowner Projects </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card">
  ...
  <div class="card-body p-0">
    <div class="table-responsive">
      <table class="table m-0">
        ...
        <tbody>
        {% for data in landowner_projects %}
        <tr>
          <td><a href="#">{{ data.project_id }}</a></td>
          <td>{{data.title}}</td>
          <td><span class="badge badge-success">{{data.allow_status}}</span></td>
  ...
  <div class="card-footer clearfix">
    <a href="landownerForm" class="btn btn-sm btn-info float-left">Place New </a>
