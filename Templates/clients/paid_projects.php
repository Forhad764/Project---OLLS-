...
<div class="card">
    ...
    <div class="table-responsive">
      <table class="table m-0">
        ...
        <tr>
          <th>Project ID</th>
          <th>Project Title</th>
          <th>Expected </br>monthly amount</th>
          <th>Agreement Status</th>
          <th>Click if agreement complete</th>
           <!--th> Popularity </th> -->
        </tr>
        </thead>
        <tbody>
        {% for data in clients_paid_projects %}
        <tr>
          ...
          <td>{{data.agreement_status}}
          <td>
            <form action="agreement_complete" method="post">
            <!--input type="hidden" name="agreement" value="True">
            <!--input type="hidden" name="project_id" value="{{Data.project_id}}"-->
            <input type="hidden" name="id" value= {{ data.id }} >

              {% csrf_token %}
              <button type="submit" value="True" class="btn btn-primary" >Agreement Complete</button >
            </form>
          </td>
        </tr>
  ...
  <div class="card-footer clearfix">
    <a href="Projects" class="btn btn-sm btn-info float-left">Place New Order </a>
